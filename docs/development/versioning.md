...
docs/changelog/
    ...
    v2.5.0.md   ← Minor: P1-7 narrow bare `except Exception` in scripts (4 sites); A2-6 obsolete `old/test.ams` warning
```
...
| [2.5.0](../changelog/v2.5.0.md)   | 2026-06-02 | Minor   | Minor: P1-7 narrow bare `except Exception` in 4 script sites; A2-6 `old/test.ams` non-functional warning |
